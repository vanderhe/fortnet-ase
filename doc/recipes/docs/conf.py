...
# -*- coding: utf-8 -*-
#
# fortnet-ase Recipes documentation build configuration file, created by
...
htmlhelp_basename = 'FortnetAseRecipesdoc'
...
latex_documents = [
    (master_doc, 'FortnetAseRecipes.tex', 'fortnet-ase Recipes Documentation',
...
man_pages = [
    (master_doc, 'fortnetaserecipes', 'fortnet-ase Recipes Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'FortnetAseRecipes', 'fortnet-ase Recipes Documentation',
     author, 'FortnetAseRecipes', 'One line description of project.',
     'Miscellaneous'),
]
